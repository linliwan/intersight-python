"""
    Use Intersight's API key v3 (based on EC private key) to initiate REST requests
...
def generate_auth_headers(api_key_id, private_key_file, method, url, body=""):
    ...
    # Use the EC private key to sign. 
    # Intersight will use your public key to verify whether the signature is legal.
    signature = base64.b64encode(
        private_key.sign(signature_string, ec.ECDSA(hashes.SHA256()))
    ).decode()
